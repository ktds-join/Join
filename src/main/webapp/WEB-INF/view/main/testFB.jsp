 ...
 */
  ...
  function testAPI() {
    ...
    FB.api('/me', { locale : 'UTF-8', fields : 'name, email'} ,function(response) {
...
<fb:login-button scope="public_profile,email" onlogin="checkLoginState();" data-auto-logout-link="true" data-size="large" data->
</fb:login-button>
<!-- 
