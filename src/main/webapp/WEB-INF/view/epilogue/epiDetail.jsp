		...
		<div id="contentForm">
			<div class="input-group input-group-sm" role="group" aria-label="...">
				...
				<div class="btn-group btn-group-sm" role="group" aria-label="..." style="margin-left: 89%;">
					<input class="btn btn-default" type="button" id="epiModifyBtn" value="수정"  />
				</div>
				<div style="margin-left:40%; margin-bottom:1%; ">
					<h5>나의 별점 : <span>${epilogue.epilogueGrade}</span></h5>
				</div>
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr>
							...
							${epilogue.memberVO.memberNickname} | ${epilogue.epilogueWriteDate}
							</td>
						</tr>
						<tr>
							<td colspan="2">
